...
export function loadPledge(): Pledge {
  ...
  return {
    text: read("onboarding.pledgeText") || read("pledge_reasons") || DEFAULT_PLEDGE,
    escapePlan: read("onboarding.escapePlan") || read("pledge_escape_plan") || DEFAULT_ESCAPE_PLAN,
    signatureDataUrl: read("onboarding.signature") || read("pledge_signature"),
    name: read("onboarding.name") || read("nickname"),
  };
}
