...
export function PledgeDocument({
  ...
  return (
    <div className="relative overflow-hidden rounded-[28px] border-2 border-[#D4CBB0] bg-[#F7F4EA] p-5 sm:p-8 text-maroon shadow-lg text-start dark:bg-[#1C1816] dark:border-[#3D3530] dark:text-[#EDEBDE] transition-all">
      {/* Scrollable Parchment Continuous Sheet */}
      <div className="max-h-[640px] overflow-y-auto pr-1 space-y-7 text-xs sm:text-sm leading-relaxed scrollbar-thin scrollbar-thumb-cherry/20">
        {/* Header Title */}
        <div className="text-center border-b border-[#D4CBB0]/70 pb-5 dark:border-[#3D3530]">
          ...
          <h1 className="font-thamanya text-3xl font-bold tracking-tight text-maroon dark:text-[#EDEBDE]">
            {isAr ? "العهد" : "The Pledge"}
          </h1>
          <p className="text-xs font-semibold text-cherry mt-1.5">
            {isAr ? "بسم الله الرحمن الرحيم" : "In the Name of God, Most Gracious, Most Merciful"}
          </p>
        </div>

        {/* Continuous Prose Section */}
        <div className="space-y-6 text-noir/90 dark:text-cotton/90 font-sans leading-relaxed">
          {/* Preamble */}
          ...
          <div className="h-px bg-gradient-to-r from-transparent via-[#D4CBB0]/80 to-transparent dark:via-[#3D3530]" />
          ...
          <div className="space-y-2.5">
            ...
            <div className="pt-1">
              <span className="block text-xs font-bold text-maroon dark:text-[#EDEBDE] mb-1">
                {isAr
                  ? "أكثر الأسباب التي تدفعني لتركها:"
                  : "The primary reasons driving me to break it:"}
              </span>
              {readOnly ? (
                <div className="w-full border-b-2 border-dashed border-[#D4CBB0] dark:border-[#4A403A] py-1.5 text-xs sm:text-sm text-cherry font-medium whitespace-pre-wrap">
                  {fieldReasons ||
                    (isAr
                ...
                <textarea
                  ...
                  className="w-full bg-transparent border-b-2 border-dashed border-[#D4CBB0] dark:border-[#4A403A] p-2 text-xs sm:text-sm font-medium text-maroon dark:text-[#EDEBDE] outline-none focus:border-cherry focus:bg-cherry/5 transition-all resize-y"
                />
              )}
            </div>
          </div>
          ...
          <div className="space-y-3 pt-1 text-maroon dark:text-[#EDEBDE]">
            <h2 className="font-bold text-cherry text-sm sm:text-base">
        ...
        <div className="pt-5 border-t-2 border-dashed border-[#D4CBB0]/80 dark:border-[#3D3530] space-y-4">
          ...
          {/* Interactive Finger Signature Canvas Box */}
